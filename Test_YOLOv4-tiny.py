...
def imShow(path):
# Use the following magic command only in a Jupyter notebook.
# %matplotlib inline
...
# The test directory contains images used to evaluate the detector.
...
# os.system('copy data/obj.names data/coco.names')
